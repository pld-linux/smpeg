...
Skompletowali∂my prace tych dwÛch projektÛw, aby stworzyÊ MPEG
video/audio player ogÛlnego przeznaczenia dla systemu Linux.

%description -l pt_BR
A SMPEG È baseada no software de decodificaÁ„o MPEG mpeg_play da
...
dois projetos para criar um reprodutor MPEG de vÌdeo e ·udio de
propÛsito geral para o sistema operacional Linux.

%package devel
Summary:	Smpeg header files and development documentation
Summary(pl):	Pliki nag≥Ûwkowe oraz dokumentacja do smpeg
Summary(pt_BR):	Bibliotecas e arquivos de inclus„o para desenvolvimento de aplicaÁıes SMPEG
...
Pliki nag≥Ûwkowe oraz dokumentacja do biblioteki smpeg.
...
Summary(pt_BR):	Bibliotecas est·ticas para desenvolvimento de aplicaÁıes SMPEG
Group:		X11/Development/Libraries
Group(de):	X11/Entwicklung/Libraries
Group(es):	X11/Desarrollo/Bibliotecas
Group(fr):	X11/Development/Librairies
...
Bibliotecas est·ticas para desenvolvimento de aplicaÁıes SMPEG.
